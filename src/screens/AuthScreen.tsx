...
<ImageBackground 
    ...
    <View style={styles.wrap}>
      ...
      <TouchableOpacity
        ...
        style={ [theme.viewStyles.button, {backgroundColor: 'white'}] }
      >
        <Image
      ...
      <TextInput
        ...
        placeholder="Email" keyboardType="email-address" value={email} onChangeText={setEmail}
      />
      <TextInput
        style={styles.input} placeholder="Password" secureTextEntry value={pw} onChangeText={setPw}
      />
...
const styles = StyleSheet.create({
  ...
  input: { borderWidth: 1, borderColor: '#ccc', borderRadius: 8, padding: 12, backgroundColor: 'white', opacity: 0.75 },
